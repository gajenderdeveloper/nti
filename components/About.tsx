...
export default function About() {
    return (
        <section id="about" className="py-10 bg-hero-texture text-[#13395d]">
            <div className="max-w-7xl mx-auto px-6 text-center">
                <h2 className="text-3xl md:text-4xl lg:text-5xl font-semibold ">About NewTech Industries (NTI)</h2>
                <p className="mt-4 text-[#13395d] text-sm lg:text-lg">Since 2009, Newtech Industries (NTI) has been a prominent manufacturer and service provider of high-precision machined parts in metal, epoxy, and plastics. We are a single-spot solution for your production line, from R&amp;D and design to final manufacturing. Our products are trusted for their precise dimensions, robust construction, and excellent finish.</p>

                <div className="mt-8 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
                    <div className="p-6 bg-white border rounded transform transition-transform duration-200 hover:-translate-y-1 hover:shadow-lg hover:border-[#13395d]">
                        ...
                        <h4 className="mt-3 font-semibold">ISO 9001:2015 & AS9100 D Certified</h4>
                    ...
                    <div className="p-6 bg-white border rounded transform transition-transform duration-200 hover:-translate-y-1 hover:shadow-lg hover:border-[#13395d]">
                        ...
                        <h4 className="mt-3 font-semibold">In-house R&amp;D and Design</h4>
                    ...
                    <div className="p-6 bg-white border rounded transform transition-transform duration-200 hover:-translate-y-1 hover:shadow-lg hover:border-[#13395d]">
                        ...
                        <h4 className="mt-3 font-semibold">Key Industries Served</h4>
                    ...
                    <div className="p-6 bg-white border rounded transform transition-transform duration-200 hover:-translate-y-1 hover:shadow-lg hover:border-[#13395d]">
                        ...
                        <h4 className="mt-3 font-semibold">Advanced Facilities</h4>
                    ...
                    <div className="p-6 bg-white border rounded transform transition-transform duration-200 hover:-translate-y-1 hover:shadow-lg hover:border-[#13395d]">
                        ...
                        <h4 className="mt-3 font-semibold">Our Vision</h4>
                    ...
                    <div className="p-6 bg-white border rounded transform transition-transform duration-200 hover:-translate-y-1 hover:shadow-lg hover:border-[#13395d]">
                        ...
                        <h4 className="mt-3 font-semibold">Our Mission</h4>
                ...
                <div className="mt-6">
                    <Link href="/about" className="inline-block bg-[#13395d] hover:bg-slate-900 text-white px-5 py-3 rounded-md">Read More</Link>
                </div>
            </div>
        </section>
    )
