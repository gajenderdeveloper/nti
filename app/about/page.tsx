                ...
                <div className="max-w-6xl mx-auto px-6 space-y-12">
                    <div className="grid gap-8">
                        <div>
                            ...
                            <p className="mt-4 text-slate-700 leading-relaxed">Incorporated in 2009 at Faridabad, Haryana, India, "NEWTECH INDUSTRIES" (NTI) is known as a prominent Manufacturer, Supplier, and Service Provider. We are occupied in offering a comprehensive range of Precision Machined parts in metal, Epoxy, and Plastics. Our offered products are widely acknowledged in the market for their qualitative features such as easy installation, precise dimensions, robust construction, application-specific design, and excellent finish.</p>
